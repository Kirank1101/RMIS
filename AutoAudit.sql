...
--SET @SQL = 'ALTER SCHEMA ' + quotename(@AuditSchema) + ' TRANSFER Audit.pAutoAudit'
--EXEC (@SQL)
--SET @SQL = 'ALTER SCHEMA ' + quotename(@AuditSchema) + ' TRANSFER Audit.pAutoAuditAll'
--EXEC (@SQL)
--SET @SQL = 'ALTER SCHEMA ' + quotename(@AuditSchema) + ' TRANSFER Audit.pAutoAuditDrop'
--EXEC (@SQL)
--SET @SQL = 'ALTER SCHEMA ' + quotename(@AuditSchema) + ' TRANSFER Audit.pAutoAuditDropAll'
--EXEC (@SQL)
--SET @SQL = 'ALTER SCHEMA ' + quotename(@AuditSchema) + ' TRANSFER Audit.pAutoAuditRebuild'
--EXEC (@SQL)
--SET @SQL = 'ALTER SCHEMA ' + quotename(@AuditSchema) + ' TRANSFER Audit.pAutoAuditRebuildAll'
--EXEC (@SQL)
--SET @SQL = 'ALTER SCHEMA ' + quotename(@AuditSchema) + ' TRANSFER Audit.pAutoAuditSetTriggerState'
--EXEC (@SQL)
--SET @SQL = 'ALTER SCHEMA ' + quotename(@AuditSchema) + ' TRANSFER Audit.pAutoAuditSetTriggerStateAll'
--EXEC (@SQL)
...
EXEC	 [Audit].[pAutoAudit]
		@TableName = BagPaymentInfo,
		@ColumnNames = '[AmountPaid],[PaidDate],[CustID],[PaymentMode]'
		
EXEC	 [Audit].[pAutoAudit]
		@TableName = BagStockInfo,
		@ColumnNames = '[Price],[CustID],[TotalBags]'
		
EXEC	 [Audit].[pAutoAudit]
		@TableName = BankTransaction,
		@ColumnNames = '[CustID],[Withdraw],[Deposit],[Balance]'
		
EXEC	 [Audit].[pAutoAudit]
		@TableName = EmployeeSalary,
		@ColumnNames = '[CustID],[Salary]'
		
EXEC	 [Audit].[pAutoAudit]
		@TableName = ExpenseTransaction,
		@ColumnNames = '[CustID],[Amount]'
		
EXEC	 [Audit].[pAutoAudit]
		@TableName = HullingProcess,
		@ColumnNames = '[CustID],[Price],[TotalBags]'
		
EXEC	 [Audit].[pAutoAudit]
		@TableName = HullingProcessExpenses,
		@ColumnNames = '[CustID],[HullingExpenses]'		
		
EXEC	 [Audit].[pAutoAudit]
		@TableName = HullingTransaction,
		@ColumnNames = '[CustID],[MRiceProdTypeID],[BrokenRiceTypeID],[TotalBags],[Price]'		
