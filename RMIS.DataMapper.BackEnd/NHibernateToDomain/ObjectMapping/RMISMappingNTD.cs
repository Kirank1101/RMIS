...
namespace RMIS.DataMapper.BackEnd.NHibernateToDomain.ObjectMapping
{
    internal class RMISMappingNTD
    {
        ...
        internal void MapMProductSellingTypeEntity()
        {
            try
            {
                Mapper.CreateMap<MProductSellingType, MProductSellingTypeEntity>()
            ...
            {
                Logger.Error("Error encountered at MapMProductSellingTypeEntity", ex);
                throw;
            }
        }
        ...
        internal void MapHullingProcessTransInfoEntity()
        {
            try
            {
                Mapper.CreateMap<HullingProcessTransaction, HullingProcessTransactionEntity>()
