...
namespace RMIS.Mediator.BackEnd.Impl
{
    ...
    public class RMISMediatorImpl : IRMISMediator
    {
        ...
        public List<PaddyPaymentDetailsEntity> GetPaddyPaymentDetailsEntity(string CustId, int pageindex, int pageSize, out int count, SortExpression sortExpression, YesNo yesNo)
        {
            return rmisGateway.GetPaddyPaymentDetailsEntity(CustId, pageindex, pageSize, out count, sortExpression, yesNo);
        }


        public List<PaddyPaymentDetailsEntity> GetPaddyPaymentDetailsEntity(string CustId, string SellerID, int pageindex, int pageSize, out int count, SortExpression sortExpression, YesNo yesNo)
        {
            return rmisGateway.GetPaddyPaymentDetailsEntity(CustId, SellerID, pageindex, pageSize, out count, sortExpression, yesNo);
        }


        public List<SellerInfoEntity> GetSellerInfoEntity(string CustId, YesNo yesNo)
        {
            return rmisGateway.GetSellerInfoEntities(CustId, yesNo);
        }
        ...
        public List<PaddyStockInfoEntity> GetPaddyStockInfoEntities(string CustId, string PaddyTypeID, YesNo yesNo)
        {
        ...
        public List<BagPaymentInfoEntity> GetBagPaymentDetailsEntity(string CustId, string SellerID, int pageindex, int pageSize, out int count, SortExpression sortExpression, YesNo yesNo)
        {
        ...
        public List<ProductPaymentTransactionEntity> GetAllProductPaymentTranEntities(string CustId, int pageindex, int pageSize, out int count, SortExpression sortExpression, YesNo yesNo)
        {
            return rmisGateway.GetAllProductPaymentTranEntities(CustId, pageindex, pageSize, out count, sortExpression, yesNo);
        }
        ...
        public PaddyStockInfoEntity GetPaddyStockOnSellerid(string CustId, string SellerId, YesNo yesNo)
        {
            return rmisGateway.GetPaddyStockOnSellerid(CustId, SellerId, yesNo);
        }
        ...
        public List<BankTransactionEntity> GetBankTransactionEntities(string CustID, int pageindex, int pageSize, out int count, SortExpression sortExpression, YesNo yesNo)
        {
        ...
        public List<PaddyPaymentDetailsEntity> GetPaddyPaymentDetailsEntity(string CustId, string PaddyPaymentID, YesNo yesNo)
        {
            return rmisGateway.GetPaddyPaymentDetailsEntity(CustId, PaddyPaymentID, yesNo);
        }


        public List<PaddyStockInfoEntity> GetReceiptPaddyStockInfoEntity(string CustId, string SellerID, int pageindex, int pageSize, out int count, SortExpression sortExpression, YesNo yesNo)
        {
        ...
        public List<ExpenseTransactionEntity> GetExpenseTransactionEntity(string CustId, DateTime FromDate, DateTime ToDate, int pageindex, int pageSize, out int count, SortExpression sortExpression, YesNo yesNo)
        {
            return rmisGateway.GetExpenseTransactionEntity(CustId, FromDate, ToDate, pageindex, pageSize, out count, sortExpression, yesNo);
        }


        public List<ExpenseTransactionEntity> GetExpenseTransactionEntity(string CustId, int pageindex, int pageSize, out int count, SortExpression sortExpression, YesNo yesNo)
        {
