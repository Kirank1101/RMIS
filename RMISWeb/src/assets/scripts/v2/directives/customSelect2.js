(function (angular) {
    ...
    angular.module('customSelect2Key', []).directive('select', ['$parse', function ($parse) {
        return {
            restrict: 'E',
            priority: '100',
            ...
            link: function (scope, elm, attrs, controllers) {
                ...
                if (!attrs.customSelect2Key || !selectController) {
                    return;
                }
                ...
                */
                ...
                var key = attrs.customSelect2Key;
    ...
    *
    * <input type="hidden" custom-select2="options" ng-model="selection" multiple custom-rendering class="span11" ></input>
    */
    angular.module('customSelect2', []).directive('customSelect2', ['$parse', '$interpolate', '$timeout', function ($parse, $interpolate, $timeout) {
        return {
            require: '?ngModel',
            priority: '150', // must be higher priority than custom-select-key
            restrict: 'A',
            ...
            link: function link(scope, elm, attrs, ngModelController) {
                ...
                var parseResult = angular.isDefined(attrs.customRendering) ?
                    function (result) { return result; } : createDefaultResultParser();
                    ...
                    angular.extend(options, scope.$eval(attrs.customSelect2));
