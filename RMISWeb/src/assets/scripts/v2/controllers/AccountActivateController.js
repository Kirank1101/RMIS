angular.module('Account', []).controller('AccountActivateController', function ($scope, $http, $parse) {
    $scope.submit = function (form) {
        ...
        if (form.$invalid) {
            ...
            $("#origMessage").html('We are now processing your request. Please wait patiently while we are activating your account...');
            $("#btnSubmit").hide();
            ...
            $http({
                method: "POST",
                url: 'Activate.aspx/ActivateAccount',
                data: parameters,
