angular.module('Account', ['serverError']).controller('AccountTokenResetActivationController', function ($scope, $http, $parse) {
    $scope.submit = function (form) {
        ...
        if (form.$invalid) {
            ...
            $http({
                method: "POST",
                url: 'TokenResetActivation.aspx/RequestToken',
                data: parameters,
