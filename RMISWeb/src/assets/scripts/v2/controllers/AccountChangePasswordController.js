angular.module('Account', ['checkStrength', 'serverError']).controller('AccountChangePasswordController', function ($scope, $http, $parse) {
    $scope.NewPassword = '';
    ...
    $scope.submit = function (form) {
        ...
        if (form.$invalid) {
            ...
            var parameterName = "changePasswordToken";
