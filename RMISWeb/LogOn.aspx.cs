...
public partial class LogOn: RegisterBasePage
{
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        if (userEntityObj != null)
        {
            ...
            mailImp.AddToMailQueue("Dear Customer" + ",\r\n\r\n <br /> <br />Please return to the  site (http://www.ormer-rims.com/) and log in using the following information" + "\r\n\r\n   <br /> <br />Your Username: " + userEntityObj.CustID + @"\" + userEntityObj.Name + "\r\n\r\n   <br />Password: " + newPassword + " \r\n\r\n   <br /><br />Thank you -Ormer Solutions,India.", " Ormer-RMIS | Membership Information ", userEntityObj.EmailId);
