<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RPT_ExpenseDetailsReport.ascx.cs"
    Inherits="RPT_ExpenseDetailsReport" %>
        ...
        <tr>
            <td>
                <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt"
                    ...
                    <LocalReport ReportPath="RDL_ExpenseDetailsReport.rdlc">
                        <DataSources>
                            <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" Name="ExpenseDetail" />
                        </DataSources>
                    </LocalReport>
                </rsweb:ReportViewer>
