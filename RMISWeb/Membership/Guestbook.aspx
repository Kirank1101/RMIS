<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Guestbook.aspx.cs"
    Inherits="Membership_Guestbook" Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <p>
        ...
        <asp:RequiredFieldValidator ID="SubjectReqValidator" runat="server" ErrorMessage="You must provide a value for Subject"
            ControlToValidate="Subject" ValidationGroup="EnterComment"></asp:RequiredFieldValidator><br />
    ...
    <p>
        <asp:Button ID="PostCommentButton" runat="server" Text="Post Your Comment" OnClick="PostCommentButton_Click"
            ValidationGroup="EnterComment" />
    </p>
    <hr />
    <h3>
        Guestbook Comments</h3>
    <asp:ListView ID="CommentList" runat="server" DataSourceID="CommentsDataSource" EnableViewState="false">
        ...
        <ItemTemplate>
            <h4>
                <asp:Label ID="SubjectLabel" runat="server" Text='<%# Eval("Subject") %>' /></h4>
            ...
            <p>
                ...
                <br />
                My Homepage:
                <asp:HyperLink ID="HomepageUrlLink" runat="server" NavigateUrl='<%# Eval("HomepageUrl") %>'
    ...
    <p>
        <asp:SqlDataSource ID="CommentsDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:SecurityTutorialsConnectionString %>"
