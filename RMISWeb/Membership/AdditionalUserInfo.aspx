<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="AdditionalUserInfo.aspx.cs"
    Inherits="Membership_AdditionalUserInfo" Title="Untitled Page" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    <h2>
        Update Your Settings</h2>
    <p>
    ...
    <asp:DetailsView ID="UserProfile" runat="server" AutoGenerateRows="False" DataKeyNames="UserId"
        DataSourceID="UserProfileDataSource" DefaultMode="Edit" OnItemUpdated="UserProfile_ItemUpdated">
        <Fields>
    ...
    <asp:SqlDataSource ID="UserProfileDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:SecurityTutorialsConnectionString %>"
