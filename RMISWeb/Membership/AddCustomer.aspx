...
<br />
 ...
 <p>
    ...
    <p>
                    ...
                    <asp:DropDownList ID="ddlCustomeList" runat="server" 
                        AppendDataBoundItems="true" AutoPostBack="true"
                        DataTextField="Name" DataValueField="CustId" Height="59px" 
    ...
    <p>
        <asp:GridView ID="gdRoleList" runat="server" AutoGenerateColumns="False" 
       ...
       <b>Select a Role:</b>
        ...
        <asp:Button ID="CreateAccountButton" runat="server" 
            ...
            <asp:GridView ID="gdUsers" runat="server" AutoGenerateColumns="true" 
