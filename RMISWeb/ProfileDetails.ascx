<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ProfileDetails.ascx.cs"
    Inherits="ProfileDetails" %>
<div class="table-responsive">

    <table>
        <tr>
            <td>
                <asp:Label runat="server" ID="lblMillName" Text="<%$Resources:Resource,MillName%>"></asp:Label>
            </td>
            <td>
                <asp:TextBox runat="server" ID="txtMillName" />
            </td>
        </tr>
        
        <tr>
            <td>
                <asp:Label runat="server" ID="lblTINNumber" Text="<%$Resources:Resource,TIN%>"></asp:Label>
            </td>
            <td>
                <asp:TextBox runat="server" ID="txtTINNumber" />
            </td>
        </tr>
        <tr>
            <td>
