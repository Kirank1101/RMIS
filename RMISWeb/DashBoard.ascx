                ...
                <div class="dashboard-widget-content">
                    ...
                    <div class="sidebar-widget">
                        ...
                        <div class="goal-wrapper">
                            <span class="gauge-value pull-left">$</span> <span id="gauge-text" class="gauge-value pull-left">
                                3,200</span> <span id="goal-text" class="goal-value pull-right">$5,000</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="x_content">
                <div class="dashboard-widget-content">
                    ...
                    <div class="sidebar-widget">
                        ...
                        <canvas width="150" height="80" id="foo" class="" style="width: 160px; height: 100px;"></canvas>
                        <div class="goal-wrapper">
                            <span class="gauge-value pull-left">$</span> <span id="Span1" class="gauge-value pull-left">
                                3,200</span> <span id="Span2" class="goal-value pull-right">$5,000</span>
                        </div>
                    </div>
                </div>
            </div>
