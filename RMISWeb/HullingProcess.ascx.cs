...
public partial class HullingProcess : BaseUserControl
{
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        {
            ITransactionBusiness imp = BinderSingleton.Instance.GetInstance<ITransactionBusiness>();
            resultDto = imp.SaveHullingProcessInfo(ddlPaddyType.SelectedValue, ddlUnitsType.SelectedValue, Convert.ToInt16(txtTotalBags.Text.Trim()), txtHullingProcessBy.Text.Trim(), Convert.ToDateTime(txtHullingProcessDate.Text.Trim()), 'P', ddlGodownName.SelectedValue);
    ...
    protected void btnSaveClose_Click(object sender, EventArgs e)
    {
        ...
        if (resultDto.IsSuccess)
        {
            ...
            ITransactionBusiness imp = BinderSingleton.Instance.GetInstance<ITransactionBusiness>();
            //Save Rice details
            resultDto = imp.SaveHullingProcessTransInfo("", "Rice", ddlRiceBrand.SelectedValue, ddlRiceType.SelectedValue, null, ddlriceUnittype.SelectedValue, Convert.ToInt16(txtricetotalbags.Text.Trim()), Convert.ToDouble(txtricepriceperbag.Text.Trim()));
