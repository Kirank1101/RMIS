<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RPT_PaddyPaymentInfo.ascx.cs"
    Inherits="RPT_PaddyPaymentInfo" %>
        ...
        <td>
            <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt"
                ...
                <LocalReport ReportPath="RDL_PaddyPaymentReport.rdlc">
                    <DataSources>
                        <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" Name="PaddyPayment" />
                    </DataSources>
                </LocalReport>
            </rsweb:ReportViewer>
