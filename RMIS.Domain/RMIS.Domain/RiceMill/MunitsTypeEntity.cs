...
{
    [Serializable]
    public class MUnitsTypeEntity : AbstractAllInOne
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            MUnitsTypeEntity toCompareWith = obj as MUnitsTypeEntity;
            return toCompareWith == null ? false : ((this.UnitsTypeID == toCompareWith.UnitsTypeID));
        }
        ...
        public override int GetHashCode()
        {
            ...
            toReturn ^= this.UnitsTypeID.GetHashCode();
            return toReturn;
        }
