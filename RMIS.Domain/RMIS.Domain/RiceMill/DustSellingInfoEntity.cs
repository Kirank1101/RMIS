...
{
    [Serializable]
    public class DustSellingInfoEntity : AbstractAllInOne
    {
        public string DustSellingID { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            DustSellingInfoEntity toCompareWith = obj as DustSellingInfoEntity;
            return toCompareWith == null ? false : ((this.DustSellingID == toCompareWith.DustSellingID));
        }
        ...
        public override int GetHashCode()
        {
            ...
            toReturn ^= this.DustSellingID.GetHashCode();
            return toReturn;
        }
