...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="src/assets/css/site.css">
...
<body>
   ...
   <![endif]-->
                ...
                <div class="row-fluid">
                    <div class="inner span7">
                        <h1>
                            BootMetro</h1>
                        <h2>
                            Metro style web framework</h2>
                        <p>
                            Simple and flexible HTML, CSS, and Javascript for web apps that wants to use the
                            "Windows 8 App Store" style, without the need to run on Windows 8.</p>
                        <p>
                            <a class="btn btn-large btn-primary" href="https://github.com/aozora/bootmetro/zipball/master">
                                Download Now <i class="icon-arrow-right-7"></i></a><span class="muted">it's free</span>
                            <br />
                            <span class="label label-success">Latest version: 1.0.0 Alpha1</span>
                        </p>
                    </div>
                    <div class="span5">
                        <img id="hero-image" class="pull-right" width="500" height="265" src="src/assets/img/hero4.png"
                            alt="hero">
                ...
                <a class="tile wide imagetext bg-color-orange first" href="https://github.com/aozora/bootmetro">
                    ...
                    <div class="column-text">
                        <div class="text-header2">
                            View project on GitHub</div>
                        <div class="text4">
                            <iframe class="github-btn" src="http://ghbtns.com/github-btn.html?user=aozora&repo=bootmetro&type=watch&count=true"
                                allowtransparency="true" frameborder="0" scrolling="0" width="100px" height="20px">
                            </iframe>
                            <iframe class="github-btn" src="http://ghbtns.com/github-btn.html?user=aozora&repo=bootmetro&type=fork&count=true"
                                allowtransparency="true" frameborder="0" scrolling="0" width="98px" height="20px">
                            </iframe>
                        </div>
                    </div>
                </a>
    ...
    <div class="marketing metro container-fluid">
        ...
        <p class="marketing-byline">
            BootMetro is built on top of the awesome <a target="_blank" href="http://twitter.github.com/bootstrap/index.html">
                Twitter Bootstrap</a> and <a target="_blank" href="http://html5boilerplate.com/">HTML5
                    Boilerplate</a> with HTML5, CSS3 and LESS.</p>
        <div class="row-fluid">
            <div class="span4">
                <h2>
                    Hub</h2>
                <div class="tile wide image">
                    <img src="src/assets/img/detail-hub.png" alt="hub" />
                </div>
                <p>
                    Give more focus to your content. With a Metro style app you give users immediately
                    focus on the primary infos, increasing the usability and reducing the distractions.</p>
            ...
            <div class="span4">
                <h2>
                    Actions</h2>
                <div class="tile wide image">
                    <img src="src/assets/img/detail-appbar-1.png" alt="appbar" />
                </div>
                <p>
                    Use the ApplicationBar to show contextual icon action.</p>
            </div>
            <div class="span4">
                <h2>
                    Navigation</h2>
                <div class="tile wide image">
                    <img src="src/assets/img/detail-headermenu.png" alt="headermenu" />
                </div>
                <p>
                    Implement the navigation in pure MetroUI style, use back-button and the header menu
                    to provide simple ways to navigate to other pages.</p>
            </div>
        </div>
        <div class="row-fluid">
            <div class="span4">
                <h2>
                    Charms</h2>
                <div class="tile wide image">
                    <img src="src/assets/img/detail-charms.png" alt="charms" />
                </div>
                <p>
                    Create charms panels to show contextual settings.</p>
            </div>
            <div class="span4">
                <h2>
                    Font Icons</h2>
                <div class="tile wide image">
                    <img src="src/assets/img/detail-icons.png" alt="icons" />
                </div>
                <p>
                    With the awesome <a href="http://keyamoon.com/icomoon">IcoMoon</a> font icon set,
                    you can use hundreds of font icons with any color and any dimension.</p>
            </div>
            <div class="span4">
                <h2>
                    Messages</h2>
                <div class="tile wide image">
                    <img src="src/assets/img/metro-messages.png" alt="icons" />
                </div>
                <p>
                    Show messages, warning and errors like Windows 8 do.</p>
            </div>
        </div>
        <div class="row-fluid">
            <div class="span4">
                <h2>
                    ListViews</h2>
                <div class="tile wide image">
                    <img src="src/assets/img/listviews.png" alt="charms" />
                </div>
                <p>
                    Show selectable lists of elements.</p>
            </div>
            <div class="span4">
                <h2>
                    Layouts</h2>
                ...
                <p>
                    Choose several Windows 8 layouts to enhance your content.</p>
            </div>
            <div class="span4">
            </div>
        </div>
    ...
    <div class="marketing container-fluid">
        <h1>
            Who's tweeting about Bootmetro ?</h1>
        <a class="twitter-timeline" href="https://twitter.com/search?q=%23bootmetro" data-widget-id="265787903525916672">
            Tweets about "#bootmetro"</a>
   ...
   <![endif]-->
    <script type="text/javascript" src="src/assets/js/google-code-prettify/prettify.js"></script>
